---
title: 'Pluralita: Budoucnost technologie pro spolupráci a demokracii'
githubLink:
dateStartedString: { day: '13', month: '08', year: '2024' }
translations:
  {
    plurality: 'Pluralita',
    subtitle: 'Budoucnost technologie pro spolupráci a demokracii',
    authorsLead: 'E. Glen Weyl, Audrey Tang a ⿻ Komunita',
    translatorsLead: 'Přeložil: Adam Sobotka',
    return: 'zpět',
    chapters: 'kapitoly',
  }
language: { en: 'czech', iso6392B: 'cz', locale: 'česky' }
translators: [Adam Sobotka]
---

Vydali jsme se na novou cestu a doufáme, že se k nám připojíte. 

Téměř deset let jsme spolupracovali s mnoha lidmi na vytvoření nového narativu pro směřování technologií - narativu, který se zaměřuje proti krátkodobému hype a autoritářské, centralizované umělé inteligenci.

Open source projekt Pluralita se snaží identifikovat způsoby, jakými se mohou vzájemně podporovat kolaborativní technologie a demokracie tak, aby podpořily hlubší úrovně uznání, respektu a rozvoje nekonečných budoucností které překlenou sociální a kulturními rozdíly. Pojďme tento koncept popsat jasněji.

Cílem Plurality je podpořit demokracii prostřednictvím digitálních technologií a vytvořit nové způsoby spolupráce s globální komunitou pomocí digitální správy přirozeně vznikající ze spolupráce internetových komunit. Věříme, že díky tomu překonáme vysoké zdi a hluboké bariéry, které dnes svět rozdělují. Touto iniciativou chceme v našem světě inspirovat rozmanitost, mezioborovou koordinaci, investice a inovativní experimenty tak, aby se tato vize stala skutečností. K tomu potřebujeme vaši pomoc.
